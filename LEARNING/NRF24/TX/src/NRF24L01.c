...
void nRF24_Init(void) {
	// Write to registers their initial values
        nRF24_CE_L();
        DelayMilliS(5);
	nRF24_WriteReg(nRF24_REG_CONFIG, 0x0a);//0x08
        DelayMilliS(5);
	nRF24_WriteReg(nRF24_REG_EN_AA, 0x01);//0x3F
	nRF24_WriteReg(nRF24_REG_EN_RXADDR, 0x01);//0x03
	nRF24_WriteReg(nRF24_REG_SETUP_AW, 0x01);
	nRF24_WriteReg(nRF24_REG_SETUP_RETR, 0xFF);
	nRF24_WriteReg(nRF24_REG_RF_CH, 0x76);
	nRF24_WriteReg(nRF24_REG_RF_SETUP, 0x06);
	nRF24_WriteReg(nRF24_REG_STATUS, 0x70);
	nRF24_WriteReg(nRF24_REG_RX_PW_P0, 5);
	nRF24_WriteReg(nRF24_REG_RX_PW_P1, 5);
	//nRF24_WriteReg(nRF24_REG_RX_PW_P2, 0);
	//nRF24_WriteReg(nRF24_REG_RX_PW_P3, 0);
	//nRF24_WriteReg(nRF24_REG_RX_PW_P4, 0);
	//nRF24_WriteReg(nRF24_REG_RX_PW_P5, 0);
