...
//#define nRF24_CSN_H() HAL_GPIO_WritePin(SCN_GPIO_Port, SCN_Pin,GPIO_PIN_SET)
//#define nRF24_CSN_L() HAL_GPIO_WritePin(SCN_GPIO_Port, SCN_Pin,GPIO_PIN_RESET)
