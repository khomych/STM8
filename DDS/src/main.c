...
void GPIO_Conf()
{
   ...
   GPIO_Init(DC_GPIO_PORT, DC_PIN, GPIO_MODE_OUT_PP_HIGH_FAST);  //CS PIN
   GPIO_Init(DATA_GPIO_PORT, DATA_PIN, GPIO_MODE_OUT_PP_HIGH_FAST);  //CS PIN
   GPIO_Init(CLK_GPIO_PORT, CLK_PIN, GPIO_MODE_OUT_PP_HIGH_FAST);  //CS PIN
